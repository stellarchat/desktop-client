...
var translate_en = {
  ...
  ficnetwork_coins: 'FIC Coins',
  ficnetwork_claim: 'Claim',
  enter_address: 'Enter your ETH address(es)',
  ...
  add: 'Add',
  next: 'Next',
  fic_claimed: "FIC Claimed",
  fic_available: "FIC Available",
  lockup: "Lockup",
  actions: "Actions",
  claim: "Claim",
  ...
  days: "days",
  from_address: "1. From your whitelisted ETH address",
  send_to: "2. Send to smart contract",
  payload: "3. This payload",
  checking: "checking...",
  done: "Done",
